...
void RPCConsole_Widget::setNumConnections(int count)
{
    if (!clientModel)
        return;
...
void RPCConsole_Widget::setNumBlocks(int count)
{
...
void RPCConsole_Widget::on_tabWidget_currentChanged(int index)
{
...
void RPCConsole_Widget::on_sldGraphRange_valueChanged(int value)
{
...
void RPCConsole_Widget::setTrafficGraphRange(int mins)
{
...
void RPCConsole_Widget::updateTrafficStats(quint64 totalBytesIn, quint64 totalBytesOut)
{
    ui->lblBytesIn->setText(FormatBytes(totalBytesIn));
    ui->lblBytesOut->setText(FormatBytes(totalBytesOut));
}

void RPCConsole_Widget::on_btnClearTrafficGraph_clicked()
{
