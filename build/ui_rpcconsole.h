...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        RPCConsole->resize(688, 459);
        RPCConsole->setStyleSheet(QStringLiteral("background:'#0a2634';"));
...
""));
        ...
        lineEdit->setStyleSheet(QStringLiteral("border:1px solid #003750;background:#1d1b29;color:white"));
...
""));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "Shard - Debug window", 0));
        label_9->setText(QApplication::translate("RPCConsole", "Shard Core", 0));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the Shard debug log file from the current data directory. This can take a few seconds for large log files.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the Shard-Qt help message to get a list with possible Shard command-line options.", 0));
#endif // QT_NO_TOOLTIP
