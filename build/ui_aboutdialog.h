...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        AboutDialog->setStyleSheet(QStringLiteral("background:'#0a2634';"));
...
""));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Shard", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Shard</b> version", 0));
